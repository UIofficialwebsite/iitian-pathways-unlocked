      ...
      <main className="pt-16">
        ...
        <div className="relative overflow-hidden flex flex-col items-center px-4 py-6 md:py-8">
          ...
          <div className="relative z-10 w-full max-w-6xl">
            {/* Breadcrumb - Normal Weight, Inter */}
            ...
            {/* QUICK LINKS - WHITE BG, 2X2 MOBILE, 1X4 PC */}
            {examCategory && (
        ...
        {/* FILTER BAR - INTER, BLUE, PIPE SEPARATORS, MOBILE SCROLL */}
        <div className="w-full bg-white border-y border-border sticky top-16 z-30 overflow-x-auto no-scrollbar">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-3 flex items-center gap-x-4 text-[#1E40AF] font-['Inter',sans-serif]">
            <button 
              ...
              className="relative text-[13px] font-normal whitespace-nowrap group pb-2 flex-shrink-0"
            >
              All Batches
            ...
            {availableBranches.map((branch, index) => (
              <React.Fragment key={branch}>
                ...
                {index < availableBranches.length - 1 && (
                  <span className="text-gray-300 font-light px-1 flex-shrink-0">|</span>
                )}
              </React.Fragment>
            ))}
          </div>
        ...
        {/* DYNAMIC BRANCH SECTIONS - PC GRID, MOBILE ONE-ROW SCROLLER */}
              ...
              availableBranches.map((branch) => {
                ...
                return (
                  <div key={branch} className="mb-16 md:mb-20">
                    ...
                    {/* PC Layout: Grid (No scroll) | Mobile Layout: Single Row Scroll */}
                    ...
                    {/* VIEW ALL BUTTON - LIGHT BLUE, NON-BOLD, INTER */}
...
const QuickLinkCard = ({ title, desc, icon: Icon, cardColor, iconColor, onClick }: {
  ...
  >
    {/* Floating Icon for PC (lg screens), Inside for Mobile/Tablet */}
