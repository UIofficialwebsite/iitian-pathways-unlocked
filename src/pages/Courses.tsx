  ...
  return (
    <div className="min-h-screen font-sans text-zinc-800 w-full overflow-x-hidden bg-white relative">
      ...
      <main className="pt-16">
        {/* TOP SECTION: Includes Background Shapes only till Quick Links */}
        <div className="relative overflow-hidden bg-[#fcfdff]">
          {/* Background Geometric Shapes - Restricted to this wrapper */}
          <div 
        ...
        {/* INVISIBLE DIFFERENTIATOR LINE */}
        <Separator className="invisible" />

        {/* COURSES LISTING: Background is White Only */}
