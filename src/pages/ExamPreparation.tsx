...
// Import the specific prep pages
    ...
    <>
      ...
      <main className="pt-20">
        <Routes>
          ...
          <Route path="jee/*" element={<JEEPrep />} />
          <Route path="neet/*" element={<NEETPrep />} />
          <Route path="iitm-bs/*" element={<IITMBSPrep />} />
        </Routes>
      </main>
      <Footer />
      <EmailPopup />
