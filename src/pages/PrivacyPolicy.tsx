              ...
              <div className="prose prose-invert prose-p:text-gray-400 prose-headings:text-white prose-headings:font-semibold prose-a:text-white prose-li:text-gray-400 max-w-none space-y-16">
                ...
                <section id="introduction" className="scroll-mt-32">
                  <p className="text-lg text-gray-300 leading-relaxed">
                    Please read the following Privacy Policy regarding the services made available on <strong className="text-white">www.unknowniitians.live</strong> and its associated platforms (collectively referred to as the "Platform").
                  </p>
                  <p>
                  ...
                  <div className="bg-[#0a0a0a] border border-white/5 p-6 rounded-lg mt-6">
                    <p className="text-sm text-gray-400">
                      <strong className="text-white">Note:</strong> We may update this Privacy Policy from time to time to reflect changes in our practices. We encourage you to review this page periodically for the latest information on our privacy practices.
                    </p>
                  </div>
                </section>
                ...
                <section id="collection" className="scroll-mt-32">
                  ...
                  <div className="mt-8 space-y-6">
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">1.2 Registration Data</h3>
                      <p>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">1.3 Social Login</h3>
                      <p>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">1.4 User Responsibility</h3>
                      <p>
                ...
                <section id="sharing" className="scroll-mt-32">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 not-prose">
                    <div className="p-6 rounded-lg border border-white/10 bg-[#0a0a0a]">
                      <strong className="text-white block mb-2 text-sm font-semibold">3.1 Service Providers & Legal</strong>
                      <p className="text-xs text-gray-400 leading-relaxed">We may share your information with payment service providers, regulatory authorities, and third-party agencies if required by law or to respond to legal processes.</p>
                    </div>
                    
                    <div className="p-6 rounded-lg border border-white/10 bg-[#0a0a0a]">
                      <strong className="text-white block mb-2 text-sm font-semibold">3.2 Business Transfers</strong>
                      <p className="text-xs text-gray-400 leading-relaxed">We may share or sell collected information if Unknown IITians merges with or is acquired by another business entity. The new entity will be required to follow this Privacy Policy.</p>
                    </div>

                    <div className="p-6 rounded-lg border border-white/10 bg-[#0a0a0a] md:col-span-2">
                      <strong className="text-white block mb-2 text-sm font-semibold">3.3 Anonymized Data</strong>
                      <p className="text-xs text-gray-400 leading-relaxed">We do not disclose personal information to advertisers. However, we may share aggregate, anonymized data to help advertisers reach specific target audiences without identifying individuals.</p>
                    </div>
                  </div>
                </section>
                ...
                <section id="safety" className="scroll-mt-32">
                  ...
                  <div className="bg-[#0a0a0a] border border-white/5 p-6 rounded-lg">
                    <h4 className="text-white font-bold text-sm mb-2">Secure Infrastructure</h4>
                    <p className="text-sm text-gray-400">
                ...
                {/* 5. Choice/Opt-Out */}
                <section id="optout" className="scroll-mt-32 border-t border-white/10 pt-16">
                  ...
                  <div className="mt-6 flex flex-col gap-2 text-sm bg-[#0a0a0a] p-6 rounded-lg border border-white/5">
