...
const EnrollmentReceipt = () => {
  ...
  useEffect(() => {
    const fetchReceiptData = async () => {
      ...
      try {
        ...
        // 2. If Paid Course & Has Order ID -> Fetch from Payments Table
  ...
  if (loading) {
    return (
      <SidebarProvider>
        <div className="min-h-screen flex w-full bg-[#f5f8ff]">
          <DashboardSidebar />
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="flex-1 overflow-y-auto p-4 md:p-8">
            <div className="mx-auto max-w-5xl">
              ...
              {/* Back Link */}
              <div className="mb-6">
                <Link to="/dashboard" className="inline-flex items-center text-sm text-slate-500 hover:text-indigo-600 transition-colors">
