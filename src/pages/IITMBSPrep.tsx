              ...
              {activeTab === 'syllabus' ? (
                <div className="flex flex-col gap-3 w-full">
                    ...
                    <div className="flex items-center gap-3 overflow-x-auto no-scrollbar pb-1">
                        ...
                        <button onClick={(e) => handleOpenDropdown('subject', e)} className="px-4 py-1.5 border border-[#e5e7eb] rounded-[30px] text-[12px] flex items-center gap-2 bg-white font-sans text-[#374151] min-w-[200px] justify-between">
                            <span className="truncate max-w-[250px]">
                                {availableSyllabusCourses.find(c => c.id === syllabusSubjectId)?.name || "Select Subject"}
                            </span>
