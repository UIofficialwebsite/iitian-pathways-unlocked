  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black flex flex-row overflow-hidden font-sans select-none animate-in fade-in">
      ...
      <div className="relative flex-1 bg-black flex flex-col group">
        ...
        {/* VIDEO FRAME - Removed scale-105 to stop cropping */}
            ...
            <div className="relative">
              ...
              {showSettings && (
                <div className="absolute bottom-14 right-0 bg-neutral-900 border border-white/10 p-2 rounded-xl w-32 shadow-2xl">
                  <p className="text-[10px] text-neutral-500 uppercase font-bold mb-1 px-2">Speed</p>
                  {[0.5, 1, 1.5, 2].map(s => (
      ...
      {showPlaylist && (
        <div className="w-80 bg-neutral-950 border-l border-white/10 flex flex-col animate-in slide-in-from-right duration-500 z-30 shadow-2xl">
