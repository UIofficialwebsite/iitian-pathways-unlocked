...
import { Sheet, SheetContent, SheetTrigger } from "@/components/ui/sheet"; // Added for mobile
import DashboardSidebar from "./DashboardSidebar"; // Added for sidebar content
...
const ModernDashboard = () => {
  ...
  const getWelcomeMessage = () => {
    ...
    if (profile?.program_type === 'IITM_BS') {
      ...
      return `Welcome, ${branchName} ${name}`;
    } else if (profile?.program_type === 'COMPETITIVE_EXAM') {
      return `Welcome, ${profile.exam_type} Aspirant${name}`;
    }
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-8 gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-2 hidden lg:block">{getSubtitle()}</p>
            </div>
